...
async function getWebSocketRpcClient(url, options = {}) {
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$viem$2f$_esm$2f$utils$2f$rpc$2f$socket$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getSocketRpcClient"])({
        async getSocket ({ onClose, onError, onOpen, onResponse }) {
            const WebSocket = await __turbopack_context__.r("[project]/node_modules/isows/_esm/native.js [app-client] (ecmascript, async loader)")(__turbopack_context__.i).then((module)=>module.WebSocket);
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$wagmi$2f$core$2f$dist$2f$esm$2f$connectors$2f$createConnector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createConnector"])((config)=>({
            ...
            async getProvider () {
                if (!walletProvider) {
                    ...
                    const { createBaseAccountSDK } = await __turbopack_context__.r("[project]/node_modules/@base-org/account/dist/index.js [app-client] (ecmascript, async loader)")(__turbopack_context__.i);
...
var init_utils = __esm(()=>{
    /*! noble-hashes - MIT License (c) 2022 Paul Miller (paulmillr.com) */ isLE = /* @__PURE__ */ (()=>new Uint8Array(new Uint32Array([
            287454020
        ]).buffer)[0] === 68)();
...
function assertSize(hexOrBytes, { size: size2 }) {
    if (size(hexOrBytes) > size2) throw new SizeOverflowError({
...
var JsonRpcIdStruct = nullable(union([
    number(),
    string()
]));
...
function encodeBase64(array2) {
    ...
    if (typeof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"] !== "undefined") {
        base64 = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"].from(array2).toString("base64");
    } else {
...
function sha2563(value, to_) {
    const to = to_ || "hex";
    const bytes = sha2562(isHex(value, {
        strict: false
    }) ? toBytes2(value) : value);
    if (to === "bytes") return bytes;
    return toHex(bytes);
...
function encode(type, value, isArray = false) {
    ...
    if (bytesMatch) {
        ...
        if (Number.parseInt(size2) !== (value.length - 2) / 2) throw new BytesSizeMismatchError({
...
function assertTransactionEIP4844(transaction) {
    ...
    if (blobVersionedHashes) {
        ...
        for (const hash2 of blobVersionedHashes){
            ...
            if (version2 !== versionedHashVersionKzg) throw new InvalidVersionedHashVersionError({
                hash: hash2,
                version: version2
            });
        }
...
function serializeTransactionLegacy(transaction, signature) {
    ...
    if (signature) {
        const v = (()=>{
            ...
            if (signature.v !== v2) throw new InvalidLegacyVError({
                v: signature.v
            });
            return v2;
        })();
...
function getCreate2Address(opts) {
    ...
    const bytecodeHash = (()=>{
        if ("bytecodeHash" in opts) {
            if (isBytes2(opts.bytecodeHash)) return opts.bytecodeHash;
...
"[project]/node_modules/@wagmi/connectors/dist/esm/gemini.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$gemini$2d$wallet$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@gemini-wallet/core/dist/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$wagmi$2f$core$2f$dist$2f$esm$2f$errors$2f$config$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@wagmi/core/dist/esm/errors/config.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$wagmi$2f$core$2f$dist$2f$esm$2f$connectors$2f$createConnector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@wagmi/core/dist/esm/connectors/createConnector.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$viem$2f$_esm$2f$utils$2f$address$2f$getAddress$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/viem/_esm/utils/address/getAddress.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$viem$2f$_esm$2f$utils$2f$encoding$2f$toHex$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/viem/_esm/utils/encoding/toHex.js [app-client] (ecmascript)");
...
function gemini(parameters = {}) {
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$wagmi$2f$core$2f$dist$2f$esm$2f$connectors$2f$createConnector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createConnector"])((config)=>({
            ...
            async getProvider () {
                if (!walletProvider) {
                    walletProvider = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$gemini$2d$wallet$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["GeminiWalletProvider"]({
...
const version = '5.10.1'; //# sourceMappingURL=version.js.map
}}),
...
{
__turbopack_context__.s({
    "baseAccount": (()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$wagmi$2f$connectors$2f$dist$2f$esm$2f$baseAccount$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["baseAccount"]),
    ...
    "gemini": (()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$wagmi$2f$connectors$2f$dist$2f$esm$2f$gemini$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["gemini"]),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$wagmi$2f$core$2f$dist$2f$esm$2f$connectors$2f$mock$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@wagmi/core/dist/esm/connectors/mock.js [app-client] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$wagmi$2f$connectors$2f$dist$2f$esm$2f$gemini$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@wagmi/connectors/dist/esm/gemini.js [app-client] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$wagmi$2f$connectors$2f$dist$2f$esm$2f$version$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@wagmi/connectors/dist/esm/version.js [app-client] (ecmascript)");
...
{
__turbopack_context__.s({
    "baseAccount": (()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$wagmi$2f$connectors$2f$dist$2f$esm$2f$exports$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$exports$3e$__["baseAccount"]),
    ...
    "gemini": (()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$wagmi$2f$connectors$2f$dist$2f$esm$2f$exports$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$exports$3e$__["gemini"]),
...
//# sourceMappingURL=node_modules_c993a147._.js.map